            ...
            <div className="mt-4 rounded-lg border border-dashed border-border/60 bg-muted/30 p-3 text-xs">
              ...
              <ul className="mt-2 space-y-1 text-muted-foreground">
                {warnings.map((warning) => (
                  <li key={warning} className={cn('leading-relaxed')}>
                    {warning}
                  </li>
                ))}
              </ul>
  ...
  const createSection = (
    <>
      <header className="flex flex-col gap-2">
        ...
        <p className="text-sm text-muted-foreground">
          Scaffold packs, plugins, and manifests without touching folders.
        </p>
      </header>
      <div className="grid gap-4 md:grid-cols-[1.2fr_1fr]">
        <Card>
          ...
          <CardContent className="space-y-2 text-sm text-muted-foreground">
            <p>Generate Common/Server scaffolding and manifest defaults.</p>
            <p>Coming soon: templates for packs and plugins.</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader>
          ...
          <CardContent className="space-y-2 text-sm text-muted-foreground">
            <p>Validate manifest.json fields with schema hints.</p>
            <p>Coming soon: JSON editor and presets.</p>
          </CardContent>
        </Card>
      </div>
    </>
  ...
  const settingsSection = (
    <>
      <header className="flex flex-col gap-2">
        ...
        <p className="text-sm text-muted-foreground">Manage install paths and preferences.</p>
      </header>
      <div className="grid gap-4 md:grid-cols-[1.2fr_1fr]">
        <Card>
          <CardHeader>
          ...
          <CardContent className="space-y-3 text-sm">
            ...
            <Button variant="secondary" onClick={handleSelectInstallPath} disabled={isScanning}>
        ...
        <Card>
          ...
          <CardContent className="space-y-3 text-sm text-muted-foreground">
            ...
            <div className="flex items-center justify-between">
              <span>Backups</span>
              <span className="text-xs text-muted-foreground">Created when applying profiles</span>
            </div>
