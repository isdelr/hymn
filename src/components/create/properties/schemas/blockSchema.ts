  ...
  sections: [
    ...
    },
    {
      ...
      properties: [
        ...
        },
        {
          ...
          label: 'State Visuals',
          type: 'array',
          description: 'Visual/audio properties per state value',
          arrayConfig: {
            itemSchema: {
              key: 'stateVisual',
              label: 'State Visual',
              ...
              objectSchema: [
                {
                  ...
                  label: 'State Name',
                  type: 'string',
                  description: 'Name of the state this applies to',
                ...
                },
                {
                  ...
                  label: 'State Value',
                  type: 'string',
                  description: 'Value that triggers these visuals',
                  placeholder: 'e.g., true, on, 1',
                },
                {
                  key: 'CustomModelAnimation',
                  label: 'Animation',
                  type: 'path',
                ...
                },
                {
                  ...
                  label: 'Light Color',
                  type: 'string',
                  description: 'Light color in this state',
                  placeholder: '#FFCC00',
                },
                {
                  key: 'Light.Intensity',
                  label: 'Light Intensity',
                  type: 'number',
                  description: 'Light brightness (0-15)',
                  numberConfig: { min: 0, max: 15, step: 1 },
                },
                {
                  key: 'Light.Radius',
                  label: 'Light Radius',
                  type: 'number',
                  description: 'Light reach distance',
                  numberConfig: { min: 0, max: 32, step: 1 },
                },
                {
                  key: 'ParticleEffect',
                  label: 'Particle Effect',
                  type: 'string',
                  description: 'Particle effect ID to spawn',
                  placeholder: 'e.g., flames, smoke',
                },
                {
                  key: 'InteractionSoundEventId',
                  label: 'Interaction Sound',
                  type: 'string',
                  description: 'Sound to play when interacting',
                  placeholder: 'Sound event ID',
                },
                {
                  key: 'AmbientSoundEventId',
                  label: 'Ambient Sound',
                  type: 'string',
                  description: 'Looping ambient sound in this state',
                  placeholder: 'Sound event ID',
                },
              ],
            },
    ...
    },
    {
      ...
      properties: [
        ...
        {
          key: 'FurnitureProperties.SeatYaw',
          label: 'Seat Yaw',
          type: 'number',
          description: 'Rotation angle for seated player (degrees)',
          defaultValue: 0,
          numberConfig: { min: -180, max: 180, step: 15 },
        },
        {
          key: 'FurnitureProperties.Seats',
          label: 'Multiple Seats',
          type: 'array',
          description: 'Configure multiple seat positions',
          arrayConfig: {
            itemSchema: {
              key: 'seat',
              label: 'Seat',
              ...
              objectSchema: [
                {
                  ...
                  type: 'array',
                  description: 'X, Y, Z offset from block center',
                  arrayConfig: {
                    itemSchema: {
                      key: 'coord',
                      label: 'Coordinate',
    ...
    },
    {
      ...
      properties: [
        ...
        {
          key: 'BlockType.Bench.InputSlotsCount',
          label: 'Input Slots',
          type: 'number',
          description: 'Number of input/ingredient slots',
          defaultValue: 9,
          numberConfig: { min: 0, max: 27, step: 1 },
        },
        {
          key: 'BlockType.Bench.FuelSlotsCount',
          label: 'Fuel Slots',
          type: 'number',
          description: 'Number of fuel slots (for furnaces)',
          defaultValue: 0,
          numberConfig: { min: 0, max: 9, step: 1 },
        },
        {
          key: 'BlockType.Bench.OutputSlotsCount',
          label: 'Output Slots',
          type: 'number',
          description: 'Number of output/result slots',
          defaultValue: 1,
          numberConfig: { min: 1, max: 9, step: 1 },
        },
        {
          key: 'BlockType.Bench.TierLevels',
          label: 'Tier Levels',
          type: 'array',
          description: 'Upgrade tiers for this bench type',
          arrayConfig: {
            itemSchema: {
              key: 'tier',
              label: 'Tier',
              ...
              objectSchema: [
                ...
                },
                {
                  ...
                  placeholder: 'e.g., Basic, Advanced, Master',
                },
                {
                  key: 'Icon',
                  label: 'Icon',
                  type: 'path',
                  description: 'Icon for this tier level',
                  pathConfig: {
                    previewType: 'image',
                    filters: [{ name: 'Images', extensions: ['png', 'jpg'] }],
                    suggestedFolder: 'Common/Icons',
                    pathPrefix: 'Common',
                  },
                },
              ],
        ...
        {
          key: 'BlockType.Bench.CategoryIcons',
          label: 'Category Icons',
          type: 'array',
          description: 'Icons for crafting categories',
          arrayConfig: {
            itemSchema: {
              key: 'categoryIcon',
              label: 'Category Icon',
              ...
              objectSchema: [
                ...
                },
                {
                  ...
                  pathConfig: {
                    previewType: 'image',
                    filters: [{ name: 'Images', extensions: ['png', 'jpg'] }],
                    suggestedFolder: 'Common/Icons/CraftingCategories',
                    pathPrefix: 'Common',
                  },
                },
              ],
            ...
            itemSchema: {
              ...
              objectSchema: [
                ...
                },
                {
                  ...
                  label: 'Effect ID',
                  type: 'string',
                  description: 'For ApplyEffect: effect to apply',
                  placeholder: 'e.g., hytale:regeneration',
                },
                {
                  key: 'EffectDuration',
                  label: 'Effect Duration',
                  type: 'number',
                  description: 'For ApplyEffect: duration in seconds',
                ...
                },
                {
                  ...
                  type: 'number',
                  description: 'For ApplyEffect: effect strength level',
                  defaultValue: 0,
                  numberConfig: { min: 0, step: 1 },
                },
                {
                  ...
                  label: 'Item ID',
                  type: 'string',
                  description: 'For GiveItem: item to give',
                  placeholder: 'e.g., hytale:gold_coin',
                },
                {
                  key: 'ItemCount',
                  label: 'Item Count',
                  type: 'number',
                  description: 'For GiveItem: quantity to give',
                  defaultValue: 1,
                  numberConfig: { min: 1, step: 1 },
                },
                {
                  ...
                  label: 'Entity ID',
                  type: 'string',
                  description: 'For SpawnEntity: entity to spawn',
                  placeholder: 'e.g., hytale:chicken',
                },
              ],
            },
          },
