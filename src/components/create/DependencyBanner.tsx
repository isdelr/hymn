import { AlertTriangle, ExternalLink, Settings, RefreshCw, CheckCircle2 } from 'lucide-react'
import { Button } from '@/components/ui/button'
import { useDependencies } from '@/hooks/queries'
import { useSelectJdkPath } from '@/hooks/mutations'
...
export function DependencyStatus() {
  ...
  return (
    <div className="flex items-center gap-2 text-xs text-yellow-600 dark:text-yellow-400">
      ...
      {java.status === 'missing' ? 'Java not found' : `Java ${java.version} (upgrade needed)`}
    </div>
  )
}
