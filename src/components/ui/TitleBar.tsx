...
const platform = window.hymnWindow.getPlatform()
...
export function TitleBar() {
  ...
  return (
    <div className="titlebar flex h-8 items-center justify-between bg-sidebar border-b border-border/30">
      {/* Drag region with app branding - add left padding on macOS for traffic lights */}
      <div className={cn('drag-region flex flex-1 items-center gap-2 px-3 h-full', isMac && 'pl-20')}>
